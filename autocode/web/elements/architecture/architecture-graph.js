 ...
 *
 * Visualiza las relaciones de import entre archivos Python como un grafo
...
import { architectureGraphStyles } from './styles/architecture-graph.styles.js';
...
export class ArchitectureGraph extends LitElement {
    static properties = {
    ...
    static styles = [themeTokens, architectureGraphStyles];
...
if (!customElements.get('architecture-graph')) {
